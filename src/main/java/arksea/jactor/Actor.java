 ...
 * @param <T>
 */
public abstract class Actor<T> extends ChildTask<T> {
    ...
    private static final Logger logger = LoggerFactory.getLogger(Thread.class.getName());
    //stopInfo: 退出请求信息，
    /*
    ...
    public Actor(String name, long maxQueueLen, T args) {
        super(name, args);
    ...
    private void execute(TypedMessage tmsg) throws Throwable {
